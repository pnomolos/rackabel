...
### D-56. `dev logs` non-`--follow` reads persisted session files directly, not the daemon (DESIGN §3.4, SPEC D §2)
...
### D-57. Per-extension session sinks use a tab-delimited record format (DESIGN §3.4)
